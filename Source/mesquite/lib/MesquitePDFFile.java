...
public class MesquitePDFFile {
	...
	private void addMetaData(Document document) {
		document.addCreator("Mesquite " + MesquiteModule.getMesquiteVersion());
		try {
	...
	public void printText(String s, java.awt.Font font) {
		...
		com.itextpdf.text.Font.FontFamily desiredFontFamily;   // "Monospaced" isn't defined in com.lowagie.text.Font
		if (font.getFamily().equals("Monospaced")) 
			desiredFontFamily = com.itextpdf.text.Font.FontFamily.COURIER;
		else desiredFontFamily = com.itextpdf.text.Font.FontFamily.TIMES_ROMAN;
		com.itextpdf.text.Font textFont;
		switch (font.getStyle()) {
		case java.awt.Font.BOLD: {
			textFont = new com.itextpdf.text.Font(desiredFontFamily,font.getSize(),Font.BOLD);
			break;
		}
		case java.awt.Font.ITALIC: {
			textFont = new com.itextpdf.text.Font(desiredFontFamily,font.getSize(),Font.ITALIC);
			break;
		}
		case java.awt.Font.PLAIN: {
			textFont = new com.itextpdf.text.Font(desiredFontFamily,font.getSize(),Font.PLAIN);
			break;
		}
		default: {
			textFont = new com.itextpdf.text.Font(desiredFontFamily,font.getSize(),Font.BOLD);
	...
	public Graphics getPDFGraphicsForComponent(Component component, Dimension dim) {
		...
		pageRectangle = new Rectangle(0.0f,imageableHeight,imageableWidth,0.0f);
		try {
...
//			addMetaData(document);
			...
			cb.addTemplate(tp,pageWidth,pageHeight);
//			document.newPage();
			g = new PdfGraphics2D(tp, pageWidth, pageHeight);
